...
cartodb.createLayer(map, 'http://photogrammar.cartodb.com/api/v2/viz/f27ad3fe-3cd0-11e3-a206-27d6fd8aecf3/viz.json',
                     {detectRetina: false})
    .addTo(map)
...
seaver1937.addTo(map); // on by default
L.control.layers(null, historicMaps, {collapsed: false}).addTo(map);
