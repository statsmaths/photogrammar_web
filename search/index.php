...
<div id="wrapper" style="background-color:#777777">
...
<form action='results.php' method='get' id='photosearch' >
<input type ="hidden" id="start" name="start" value=0>
<fieldset>
<div>
<legend style="font-family:sans-serif;font-weight:bold;color:white">Full Text</legend>
...
<legend style="font-family:sans-serif;font-weight:bold;color:white">Advanced</legend>
